...
export default function ListaCuCeVorPersoaneleSaSpuna() {
  const [numarUsi, setNumarUsi] = useState('');
  ...
  return (
    <View style={{ padding: 20 }}>
      {/* Cate usi */}
      <Text>Câte uși aveți de montat?</Text>
      <TextInput
        style={{ borderWidth: 1, borderColor: '#ccc', marginVertical: 10, padding: 8 }}
        keyboardType="numeric"
        placeholder="Introduceți numărul de uși"
        value={numarUsi}
        onChangeText={setNumarUsi}
      />

      {/* Detalii lucrare */}
      <Text>Detalii despre lucrare (uși, locație etc.):</Text>
      <TextInput
